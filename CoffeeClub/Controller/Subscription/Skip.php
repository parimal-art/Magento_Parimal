...
class Skip implements HttpPostActionInterface
{
    ...
    public function execute()
    {
        ...
        try {
            $this->subscriptionManagement->skipNext($subscriptionId, $customerId);
            $this->messageManager->addSuccessMessage(
                __('Next delivery skipped. Your following delivery will proceed as scheduled.')
            );
