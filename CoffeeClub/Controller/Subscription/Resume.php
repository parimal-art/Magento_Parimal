...
class Resume implements HttpPostActionInterface
{
    ...
    public function execute()
    {
        ...
        try {
            $this->subscriptionManagement->resume($subscriptionId, $customerId);
            $this->messageManager->addSuccessMessage(__('Subscription resumed.'));
